...
namespace ZarzadzanieKatedraWFormsach
{
    public class Prowadzacy //: IComparable
    {
        ...
        /// konstruktor
        /// </summary>
        public Prowadzacy(int id, string imie, string nazwisko, int pesel, string tytul, string stanowisko, string typPracownika, List<string> przedmiotyKtorychMozeUczyc, int liczbaPrzedmiotowKtorychMozeUczyc)
        {
            Id = id;
            Imie = imie;
            Nazwisko = nazwisko;
